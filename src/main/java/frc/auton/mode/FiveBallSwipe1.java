...
public class FiveBallSwipe1 implements AutonMode{
    @Override
	public void addToMode(AutonBuilder ab) {
		...
		ab.addCommand(new DriveToPointVisionAngle(0.0, 1.1, -73, 0.0, 0.09, 5000));
        ...
        ab.addCommand(new DriveToPoint(-6.8, 0.55, -30, 0.0, 0.85,0.1, 5000));
        ab.addCommand(new DriveToPoint(-6.5, 0.40, -30, 0.0, 0.4,0.1, 5000));
        ab.addCommand(new DriveWait());
